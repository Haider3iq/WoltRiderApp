...
export default function Timeline ({pickTime, deliver}) {
    ...
    return (
      ...
      >
        ...
        <Text
      style={styles.heading}>{"Timeline"}</Text>
...
<View
      ...
      >
        ...
        <Text
      style={styles.heading}>{"Pick"}</Text>
...
<View
      style={{flexDirection: "row", alignItems: "center",}}
      >
       <MaterialCommunityIcons name="truck-delivery-outline" style={[styles.iconSize, {marginRight: "5%",}]} />

        <Text
      style={styles.heading}>{"Deliver"}</Text>
